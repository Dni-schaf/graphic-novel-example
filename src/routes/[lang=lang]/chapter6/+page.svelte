...
<ComicSection chapterName="chapter6" imageNames={imageSets} {imageTexts} onHeightChange={(h) => updateHeight(0, h)}/>
<MapSection dateStart="02.11.1910" dateEnd="25.11.1910" onHeightChange={(h) => updateHeight(1, h)}/>
