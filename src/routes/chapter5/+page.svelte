...
<ComicSection chapterName="chapter5" imageNames={imageSets} {imageTexts} onHeightChange={(h) => updateHeight(0, h)}/>
<MapSection dateStart="12.10.1910" dateEnd="01.11.1910" onHeightChange={(h) => updateHeight(1, h)}/>
